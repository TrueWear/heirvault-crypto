...
type DekProofPurpose = 'allow_replace' | 'mint_kill_key' | 'mint_panic_key' | 'rotate_vault_crypto' | 'store_recovery_wrap' | 'publish_handoff' | 'mark_handoff_stale' | 'rotate_vault_identity';
